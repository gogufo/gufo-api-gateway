...
type Request struct {
	...
	Files []string `protobuf:"bytes,25,rep,name=Files,proto3" json:"Files,omitempty"`
	// Optional: internal request (used by gateway)
	IR *InternalRequest `protobuf:"bytes,26,opt,name=IR,proto3,oneof" json:"IR,omitempty"`
}
...
func (x *Request) GetFiles() []string {
	if x != nil {
		return x.Files
	}
	return nil
...
type Error struct {
	...
	Code    int32             `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`                                                                                        // Numeric error code
	Message string            `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`                                                                                   // Human-readable message
	Meta    map[string]string `protobuf:"bytes,3,rep,name=meta,proto3" json:"meta,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Optional metadata (debug info, trace, etc.)
}
...
type Response struct {
	...
	Data        map[string]*anypb.Any `protobuf:"bytes,1,rep,name=Data,proto3" json:"Data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Main response payload
	RequestBack *Request              `protobuf:"bytes,2,opt,name=RequestBack,proto3,oneof" json:"RequestBack,omitempty"`                                                                     // Original request reference (optional)
	Code        *UploadStatusCode     `protobuf:"varint,3,opt,name=Code,proto3,enum=UploadStatusCode,oneof" json:"Code,omitempty"`                                                            // Upload result (if file upload)
	Error       *Error                `protobuf:"bytes,4,opt,name=error,proto3,oneof" json:"error,omitempty"`                                                                                 // Unified error object (optional)
}
...
var file_microservice_proto_rawDesc = []byte{
	...
	0x80, 0x09, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x06, 0x4d,
	...
	0x61, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x14, 0x0a, 0x05, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x18,
	0x19, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x25, 0x0a, 0x02,
	0x49, 0x52, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x17, 0x52, 0x02, 0x49, 0x52,
	0x88, 0x01, 0x01, 0x1a, 0x4d, 0x0a, 0x09, 0x41, 0x72, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	...
	,
	...
	,
	...
	,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xa5, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	,
	...
	0x64, 0x65, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x33, 0x0a, 0x09,
	0x46, 0x69, 0x6c, 0x65, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a,
	0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x22, 0x7a, 0x0a, 0x09, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4d, 0x61, 0x70, 0x12, 0x31,
	0x0a, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x17, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4d, 0x61, 0x70, 0x2e, 0x45, 0x6e, 0x74, 0x72,
	...
	0x10, 0x02, 0x32, 0x47, 0x0a, 0x07, 0x52, 0x65, 0x76, 0x65, 0x72, 0x73, 0x65, 0x12, 0x19, 0x0a,
	0x02, 0x44, 0x6f, 0x12, 0x08, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x09, 0x2e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x65,
...
var file_microservice_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_microservice_proto_goTypes = []interface{}{
	...
	(*StringMap)(nil),       // 6: StringMap
	nil,                     // 7: Request.ArgsEntry
	nil,                     // 8: InternalRequest.ArgsEntry
	nil,                     // 9: Error.MetaEntry
	nil,                     // 10: Response.DataEntry
	nil,                     // 11: StringMap.EntriesEntry
	(*anypb.Any)(nil),       // 12: google.protobuf.Any
}
var file_microservice_proto_depIdxs = []int32{
	7,  // 0: Request.Args:type_name -> Request.ArgsEntry
	2,  // 1: Request.IR:type_name -> InternalRequest
	8,  // 2: InternalRequest.Args:type_name -> InternalRequest.ArgsEntry
	9,  // 3: Error.meta:type_name -> Error.MetaEntry
	10, // 4: Response.Data:type_name -> Response.DataEntry
	1,  // 5: Response.RequestBack:type_name -> Request
	0,  // 6: Response.Code:type_name -> UploadStatusCode
	3,  // 7: Response.error:type_name -> Error
	11, // 8: StringMap.entries:type_name -> StringMap.EntriesEntry
	12, // 9: Request.ArgsEntry.value:type_name -> google.protobuf.Any
	12, // 10: InternalRequest.ArgsEntry.value:type_name -> google.protobuf.Any
	12, // 11: Response.DataEntry.value:type_name -> google.protobuf.Any
	1,  // 12: Reverse.Do:input_type -> Request
	1,  // 13: Reverse.Stream:input_type -> Request
	4,  // 14: Reverse.Do:output_type -> Response
	4,  // 15: Reverse.Stream:output_type -> Response
